<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods: {
             ...
             */
            loadStats() {
                return this.$http.get(window.Horizon.basePath + '/api/stats')
                    .then(response => {
             ...
             */
            loadWorkers() {
                return this.$http.get(window.Horizon.basePath + '/api/masters')
                    .then(response => {
             ...
             */
            loadWorkload() {
                return this.$http.get(window.Horizon.basePath + '/api/workload')
                    .then(response => {
            ...
            <table class="table table-hover table-sm mb-0">
                ...
                <tbody>
                    <template v-for="(queue, index) in workload">
                        ...
                        <tr v-for="(split_queue, index) in queue.split_queues" :key="index">
                            <td>
