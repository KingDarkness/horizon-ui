    ...
    <div>
        <div class="card">
            ...
            <div class="card-body card-bg-secondary" v-if="ready">
                ...
                <div class="row mb-2" v-if="job.payload.retry_of">
                    ...
                    <div class="col">
                         <a :href="window.Horizon.basePath + '/failed/' + job.payload.retry_of">
        ...
        <div class="card mt-4" v-if="ready && job.retried_by.length">
            ...
            <table class="table table-hover table-sm mb-0">
                ...
                <tr v-for="(retry, index) in job.retried_by" :key="index">
                    <td>
                    ...
                    <td class="table-fit">
                        <a v-if="retry.status == 'failed'" :href="window.Horizon.basePath + '/failed/'+retry.id">
                            {{ retry.id }}
                        </a>
